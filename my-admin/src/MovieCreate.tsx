// MovieCreate.tsx
import { Create, SimpleForm, TextInput, ArrayInput, SimpleFormIterator, EditProps } from 'react-admin';

export const MovieCreate = (props: EditProps) => (
    <Create title="Thêm Movie Mới" {...props}>
        <SimpleForm>
